...
* cite other tools in the space (taxize + citations)
* Frandz citations - grumpy systemitists; we're not doing anything inferential
* no spell check/name modification
* could be more than one name for rank
* versioning paragraph - argument for version like provider; we process every so often
  * comment on the release schedule, rolling is not always up to date
