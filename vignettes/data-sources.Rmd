...
`taxadb_provider_info()` gives each provider's authority, home page, licence
and preferred citation from within R; they are kept there rather than written
out here so that a provider moving a page does not leave a dead link in a
